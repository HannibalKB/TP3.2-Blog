...
//*************************************网站设置****************************************
    ...
    'ADMIN_EMAIL'               =>  '992584464@qq.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  'Hannibal',             //网站名：
    'WEB_KEYWORDS'              =>  '技术博客,个人博客,blog',         //网站关键字
    'WEB_DESCRIPTION'           =>  '个人博客',      //网站描述
    'AUTHOR'                    =>  'Hannibal',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为Hannibal原创文章,转载无需和我联系,但请注明来自博客hannibal.com',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  'Hannibal', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'hannibal',      //文字水印内容
...
//*************************************第三方登录****************************************
    'QQ_APP_ID'                 =>  '101381568',            // QQ登陆APP D
    'QQ_APP_KEY'                =>  '04b8fa5eea4131812fb65f95c04a2790',           // QQ登陆APP KEY
